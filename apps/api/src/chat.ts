...
When the working folder context IS present, the folder is already attached: never tell the user to add a folder, never mention the + button, and never correct yourself about it mid-answer.
